...
### 6-A. 깔때기 뒤집기 검증 — 풀 밖 수급-우선 신호 (예정: 2026-07-20)

- **내용**: `market_flow_daily`(v3.93, 전 종목 일별 수급+가격)에서 "순위에 뜨기 전" 매집 신호(기관/외인 연속 순매수 + 거래량 점증 + 가격 횡보)를 형성해, **풀 밖 수급 신호 vs KOSPI vs 현행 TOP3**를 D+1→D+10으로 3자 비교하는 검증 스크립트 작성.
