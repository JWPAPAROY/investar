...
**스윗스팟 우선순위** (v3.76, 90일 472건 데이터 기반):

| 순위 | 점수 구간 | 근거 |
|------|----------|------|
| 1순위 | 50-59점 | 평균max +31.0%, +10%도달 61%, 중앙값 +18.0% (N=286) |
| 2순위 | 60-69점 | 평균max +21.4%, +10%도달 59%, 중앙값 +12.4% (N=127) |
| 3순위 | 80-89점 | N=16 |
| 4순위 | 90+점 | 샘플 부족 |
| 5순위 | 70-79점 | 평균max +17.1%, +10%도달 47%, 최후 보충 |
| 6순위 | 45-49점 | 승률 53%, +10%도달 21%, B등급 하단 최후 보충 (v3.81) |
